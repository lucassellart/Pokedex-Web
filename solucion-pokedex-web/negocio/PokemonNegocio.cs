...
namespace negocio
{
    public class PokemonNegocio
    {
        ...
        public List<Pokemon> listar()   // Método que lea registros de la base de datos:
        {
            ...
            try
            {
                conexion.ConnectionString = "server=.\\SQLEXPRESS; database=POKEDEX_DB; integrated security=true; trustServerCertificate=true;";    // Dirección de mi motor de base de datos local
